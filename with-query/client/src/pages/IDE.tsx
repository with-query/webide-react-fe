    ...
    <div className="min-h-screen gradient-bg flex flex-col">
      ...
      <div className="flex flex-1 h-screen">
        ...
        <div className="w-80 modern-sidebar flex flex-col">
          {/* Tab Headers */}
          <div className="flex border-b border-white/30 p-2">
            <button
              onClick={() => setActiveView('query-builder')}
              className={`flex-1 px-6 py-3 text-sm font-semibold transition-all duration-300 rounded-full mx-1 ${
                activeView === 'query-builder'
                  ? 'bg-gradient-to-r from-orange-400 to-pink-500 text-white shadow-lg'
                  : 'bg-transparent text-muted-foreground hover:text-dark-text hover:bg-white/50'
              }`}
            >
              🗃️ Tables
            </button>
