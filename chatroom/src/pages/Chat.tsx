  ...
  return (
    <div className="min-h-screen bg-warm-beige">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-dark-text mb-2">Team Chat</h1>
            ...
            <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-2">
              {messagesLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="font-medium text-dark-text mb-2">No messages yet</h3>
                        ...
                        <div className={`flex-1 max-w-xs ${isOwnMessage ? "text-right" : ""}`}>
                          <div className="flex items-center space-x-2 mb-1">
                            <span className="text-xs font-medium text-dark-text">
                              {isOwnMessage ? "You" : (message.user.firstName || "User")}
                            </span>
